      ...
      <main className="main">
          ...
          <div className="home__container  grid">
            <div className="home__data">
              ...
              <p className="home__description">
                MedBlock is a secure blockchain based platform for storage of
        ...
        <section className="contact section container" id="contact">
            <div className="contact__container grid">
                ...
                <ul className="contact__content grid">
                    <li className="contact__address">Telephone: <span className="contact__information">+91 9541412933</span>
                    </li>
                    <li className="contact__address">Email: <span
                            className="contact__information">medblock.io@gmail.com</span></li>
                    <li className="contact__address">Location: <span className="contact__information">MIET Kot Bhalwal, Jammu - J&K 181122</span></li>
                </ul>
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3353.245028413028!2d74.8165220762003!3d32.81227208218263!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391e87ad2533b009%3A0x77069456c55e9f86!2sModel%20Institute%20of%20Engineering%20and%20Technology%20(MIET)%2C%20Jammu!5e0!3m2!1sen!2sin!4v1715163952502!5m2!1sen!2sin"
        ...
        <footer className="footer section">
          <p className="footer__copy">
            Design And Developed By The MarsMerkle
          </p>
          <p className="footer__copy">&#169; MedBlock. All right reserved</p>
        </footer>
    </div>
  );
};
